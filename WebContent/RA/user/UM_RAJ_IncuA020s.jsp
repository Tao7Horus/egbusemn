 <!--/**************************************************************************************/
/*                                                                                        */
/*    Program ID    :     UM_RAJ_IncuA020s.jsp                                            */
/*                                                                                        */
...
<table width="100%" border="0" cellspacing="1" cellpadding="0" class="tr">
	...
	<tr> 
		...
		<td class="tdb"		width="30%" height="23">&nbsp;<%=insert_minus_jumin_star(ett.getdaepyojuminNo())%></td> <!-- 2007.03.23 나라장터 내 주민등록번호 표시체계 개선 -->
	</tr>
 	<tr> 
		<td class="tdar">본사주소&nbsp;</td>
		<td class="tdb" colspan="3">&nbsp;<%=ett.getbonsaAdd()%></td>
	</tr>	
	<tr> 
		<td height="2" class="line" colspan=4></td>
	</tr>		  
...
<table width="100%" cellpadding="2" cellspacing="2">
  <tr> 
	<td align="center"><a href="javascript:js_submit();"><img src="/img/bu_ok.gif" border="0" align="absmiddle"></a></td>
 </tr>
</table>
      </td>
    </tr>
