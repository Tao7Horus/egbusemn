...
public class UM_GOV_ConiC010c
{
    public UM_GOE_ConiC010b select_user(final String s) {
        ...
        try {
            final String string = "select distinct 사업자등록번호,국적,상호명,영문상호명,                                개업일자, 법인설립일자,업무구분, 제조구분,\t대표업종코드_표준,                법인등록번호,기업구분1,기업구분2, 기업구분해당년도, 자본금,                 종업원수, 최근결산년월, 우편번호,지역코드, 주소, 나머지주소,                전화번호, FAX번호, 홈페이지, 특례해당여부,등록유효일자,                    등록일자,갱신일자,대표인증여부,처리자ID                    FROM  사용_조달업체마스터       WHERE 사업자등록번호='" + s + "' ";
            ...
            Log.debug("UM_GOV_ConiC010c.select_user('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.select_user('" + s + "'):" + ex2.toString());
        }
        finally {
    ...
    public UM_GOE_ConiC020b[] select_MS(final String s) {
        ...
        PreparedStatement prepareStatement = null;
        try {
            final String string = "  SELECT distinct 면허코드,면허번호, 면허취득일자, 면허만료일자,           시공능력평가액,평가액기준년도,대표면허여부                 FROM 사용_면허사항   \t                                   \t WHERE 사업자등록번호='" + s + "' order by 대표면허여부 desc  ";
            trx = new Trx(this, "usemn");
            connection = trx.getConnection();
            prepareStatement = connection.prepareStatement(string);
            executeQuery = prepareStatement.executeQuery();
            ...
            Log.debug("UM_GOV_ConiC010c.select_MS('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.select_MS('" + s + "'):" + ex2.toString());
        }
        finally {
            if (executeQuery != null) {
                try {
    ...
    public int Max_count(final String s) {
        ...
        int int1 = 0;
        try {
            final String string = "  SELECT count(면허코드)            FROM  사용_면허사항                WHERE 사업자등록번호='" + s + "' ";
            trx = new Trx(this, "usemn");
            connection = trx.getConnection();
            prepareStatement = connection.prepareStatement(string);
            executeQuery = prepareStatement.executeQuery();
            ...
            Log.debug("UM_GOV_ConiC010c.Max_count('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.Max_count('" + s + "'):" + ex2.toString());
        }
        finally {
            if (executeQuery != null) {
                try {
    ...
    public UM_GOE_ConiC030b[] select_DP(final String s) {
        ...
        PreparedStatement prepareStatement = null;
        try {
            final String string = "  SELECT DISTINCT  대표자주민번호, 대표자명, 대표자메일주소, 대표대표자여부     FROM  사용_대표자           WHERE 사업자등록번호='" + s + "' order by 대표대표자여부 desc ";
            trx = new Trx(this, "usemn");
            connection = trx.getConnection();
            prepareStatement = connection.prepareStatement(string);
            executeQuery = prepareStatement.executeQuery();
            ...
            Log.debug("UM_GOV_ConiC010c.select_DP('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.select_DP('" + s + "'):" + ex2.toString());
        }
        finally {
            if (executeQuery != null) {
                try {
    ...
    public int Max_count3(final String s) {
        ...
        int int1 = 0;
        try {
            final String string = "  SELECT  count(대표자주민번호)      FROM   사용_대표자               WHERE  사업자등록번호='" + s + "'";
            trx = new Trx(this, "usemn");
            connection = trx.getConnection();
            prepareStatement = connection.prepareStatement(string);
            executeQuery = prepareStatement.executeQuery();
            ...
            Log.debug("UM_GOV_ConiC010c.Max_count3('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.Max_count3('" + s + "'):" + ex2.toString());
        }
        finally {
            if (executeQuery != null) {
                try {
    ...
    public UM_GOE_ConiC040b[] select_GJ(final String s) {
        ...
        PreparedStatement prepareStatement = null;
        try {
            final String string = "  SELECT DISTINCT  일련번호,공장명,공장주소,공장나머지주소,공장전화번호,공장FAX번호,공장우편번호    FROM  사용_공장정보    WHERE 사업자등록번호='" + s + "'";
            trx = new Trx(this, "usemn");
            connection = trx.getConnection();
            prepareStatement = connection.prepareStatement(string);
            executeQuery = prepareStatement.executeQuery();
            ...
            Log.debug("UM_GOV_ConiC010c.select_GJ('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.select_GJ('" + s + "'):" + ex2.toString());
        }
        finally {
            if (executeQuery != null) {
                try {
    ...
    public int Max_count4(final String s) {
        ...
        int int1 = 0;
        try {
            final String string = " SELECT count(일련번호)  FROM  사용_공장정보\t     WHERE 사업자등록번호='" + s + "'";
            trx = new Trx(this, "usemn");
            connection = trx.getConnection();
            prepareStatement = connection.prepareStatement(string);
            executeQuery = prepareStatement.executeQuery();
            ...
            Log.debug("UM_GOV_ConiC010c.Max_count4('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.Max_count4('" + s + "'):" + ex2.toString());
        }
        finally {
            if (executeQuery != null) {
                try {
    ...
    public UM_GOE_ConiC050b[] select_ID(final String s) {
        ...
        PreparedStatement prepareStatement = null;
        try {
            final String string = "  SELECT DISTINCT  주민등록번호,성명,부서,직책명, 전화번호,E_MAIL,휴대폰,FAX     FROM  사용_입찰대리인                                      WHERE 사업자등록번호='" + s + "'";
            trx = new Trx(this, "usemn");
            connection = trx.getConnection();
            prepareStatement = connection.prepareStatement(string);
            executeQuery = prepareStatement.executeQuery();
            ...
            Log.debug("UM_GOV_ConiC010c.select_ID('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.select_ID('" + s + "'):" + ex2.toString());
        }
        finally {
            if (executeQuery != null) {
                try {
    ...
    public int Max_count5(final String s) {
        ...
        int int1 = 0;
        try {
            final String string = "  SELECT count(주민등록번호)       FROM  사용_입찰대리인 \t\t   WHERE 사업자등록번호='" + s + "'";
            trx = new Trx(this, "usemn");
            connection = trx.getConnection();
            prepareStatement = connection.prepareStatement(string);
            executeQuery = prepareStatement.executeQuery();
            ...
            Log.debug("UM_GOV_ConiC010c.Max_count5('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.Max_count5('" + s + "'):" + ex2.toString());
        }
        finally {
            if (executeQuery != null) {
                try {
    ...
    public UM_GOE_ConiC060b[] select_SUP(final String s) {
        ...
        PreparedStatement prepareStatement = null;
        try {
            final String string = "  SELECT DISTINCT  a.물품분류번호, a.형식승인번호, a.최근3년간_매출액, a.제조여부, a.대표물품여부, b.분류명    FROM 사용_조달품목 a, SYN_VIEW_물품분류매핑 b                                                           WHERE  a.물품분류번호=b.물품분류                                                                       AND    a.사업자등록번호='" + s + "' AND a.제조여부='N'  order by a.대표물품여부 desc ";
            trx = new Trx(this, "usemn");
            connection = trx.getConnection();
            prepareStatement = connection.prepareStatement(string);
            executeQuery = prepareStatement.executeQuery();
            ...
            Log.debug("UM_GOV_ConiC010c.select_SUP('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.select_SUP('" + s + "'):" + ex2.toString());
        }
        finally {
            if (executeQuery != null) {
                try {
    ...
    public int Max_countSUP(final String s) {
        ...
        int int1 = 0;
        try {
            final String string = "  SELECT count(distinct a.물품분류번호)   FROM 사용_조달품목 a, SYN_VIEW_물품분류매핑 b    WHERE  a.물품분류번호=b.물품분류                 AND    a.사업자등록번호='" + s + "' AND a.제조여부='N'  order by a.대표물품여부 desc ";
            trx = new Trx(this, "usemn");
            connection = trx.getConnection();
            prepareStatement = connection.prepareStatement(string);
            executeQuery = prepareStatement.executeQuery();
            ...
            Log.debug("UM_GOV_ConiC010c.Max_countSUP('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.Max_countSUP('" + s + "'):" + ex2.toString());
        }
        finally {
            if (executeQuery != null) {
                try {
    ...
    public UM_GOE_ConiC060b[] select_JP(final String s) {
        ...
        PreparedStatement prepareStatement = null;
        try {
            final String string = "  SELECT DISTINCT  a.물품분류번호 , a.형식승인번호, a.형식승인기관, a.형식승인일,                      a.최근3년간_매출액 , a.제조여부, a.대표물품여부, b.분류명        FROM 사용_조달품목 a, SYN_VIEW_물품분류매핑 b                                   WHERE  a.물품분류번호=b.물품분류                                                AND  a.사업자등록번호='" + s + "' AND a.제조여부='Y' order by a.대표물품여부 desc";
            trx = new Trx(this, "usemn");
            connection = trx.getConnection();
            prepareStatement = connection.prepareStatement(string);
            executeQuery = prepareStatement.executeQuery();
            ...
            Log.debug("UM_GOV_ConiC010c.select_JP('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.select_JP('" + s + "'):" + ex2.toString());
        }
        finally {
            if (executeQuery != null) {
                try {
    ...
    public int Max_count6(final String s) {
        ...
        int int1 = 0;
        try {
            final String string = "  SELECT  count(distinct a.물품분류번호)                         FROM 사용_조달품목 a, SYN_VIEW_물품분류매핑 b                   WHERE  a.물품분류번호=b.물품분류                               AND  a.사업자등록번호='" + s + "' AND a.제조여부='Y' order by a.대표물품여부 desc";
            trx = new Trx(this, "usemn");
            connection = trx.getConnection();
            prepareStatement = connection.prepareStatement(string);
            executeQuery = prepareStatement.executeQuery();
            ...
            Log.debug("UM_GOV_ConiC010c.Max_count6('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.Max_count6('" + s + "'):" + ex2.toString());
        }
        finally {
            if (executeQuery != null) {
                try {
    ...
    public UM_GOE_ConiC070b[] select_state(final String s) {
        ...
        PreparedStatement prepareStatement = null;
        try {
            final String string = "  SELECT  TO_CHAR(발생일자,'YYYY-MM-DD') 발생일자,  상태구분,   비고,      TO_CHAR(시작일자,'YYYY-MM-DD') 시작일자, TO_CHAR(종료일자,'YYYY-MM-DD') 종료일자     FROM  사용_업체상태\t                                     WHERE 사업자등록번호='" + s + "' order by 발생일자 asc";
            trx = new Trx(this, "usemn");
            connection = trx.getConnection();
            prepareStatement = connection.prepareStatement(string);
            executeQuery = prepareStatement.executeQuery();
            ...
            Log.debug("UM_GOV_ConiC010c.select_state('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.select_state('" + s + "'):" + ex2.toString());
        }
        finally {
            if (executeQuery != null) {
                try {
    ...
    public int Max_statecount(final String s) {
        ...
        int int1 = 0;
        try {
            final String string = " select  count(*)                 FROM  사용_업체상태\t\t          WHERE 사업자등록번호='" + s + "'";
            trx = new Trx(this, "usemn");
            connection = trx.getConnection();
            prepareStatement = connection.prepareStatement(string);
            executeQuery = prepareStatement.executeQuery();
            ...
            Log.debug("UM_GOV_ConiC010c.Max_statecount('" + s + "'):" + ex.toString());
        }
        catch (Exception ex2) {
            Log.debug("UM_GOV_ConiC010c.Max_statecount('" + s + "'):" + ex2.toString());
        }
        finally {
            if (executeQuery != null) {
                try {
