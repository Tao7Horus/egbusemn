...
public class UM_FOB_Forn053
{
    public UM_FOE_CommInfo[] getUpchInfo(final UM_FOE_CommInfo um_FOE_CommInfo, final int n, final int n2) {
        ...
        try {
            ...
            if (um_FOE_CommInfo.getString1().length() > 0) {
                s = s + "  사업자등록번호 like '" + string2 + "%'";
                new StringBuffer().append(s2).append("  and 사업자등록번호 like '").append(string2).append("%'").toString();
            }
            if (um_FOE_CommInfo.getString2().length() > 0) {
                s = s + "   상호명 like '%" + um_FOE_CommInfo.getString2() + "%'";
            }
    ...
    public UM_FOE_CommInfo[] getUpchInfoB(final UM_FOE_CommInfo um_FOE_CommInfo, final int n, final int n2) {
        Trx tr = null;
        Connection connection = null;
        PreparedStatement prepareStatement = null;
        ResultSet executeQuery = null;
    ...
    public int getCountB(final UM_FOE_CommInfo um_FOE_CommInfo) {
        Trx tr = null;
        Connection connection = null;
        PreparedStatement prepareStatement = null;
        ResultSet executeQuery = null;
