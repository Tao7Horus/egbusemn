...
public class UM_ADV_GovrA010c01 extends HttpServlet
{
    public void service(final HttpServletRequest httpServletRequest, final HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        if (stringParameter23.equals("Insert")) {
            try {
                ...
                httpServletResponse.sendRedirect("/AD/UM_ADJ_GovrL010s.jsp?recept=" + maxReceptionID + "&approvalCode=" + string + "&G2BCODE=" + stringParameter);
                return;
            }
            catch (Exception ex) {
                try {
        ...
        if (stringParameter23.equals("approval")) {
            ...
            try {
                ...
                Log.debug("UM_ADV_GovrA010c01.java flag[" + stringParameter23 + "] : " + ex2.toString());
 ...
 //send email
                    ...
                    UM_ADJ_GovuA020b ettcode = new UM_ADB_GovrA010c().Document_Confirm(g2bCode, stringParameter31, stringParameter32);
                    new MailServer().sendRegistrationEmailToNhaThauStep2(ettcode.getEMAIL(), ettcode.getMYNAME(), ettcode.getCNAME(), ettcode.getdependCode(), ettcode.getrefername());
                    httpServletResponse.sendRedirect("/AD/UM_ADJ_GovrL025s01.jsp?g2bCode=" + g2bCode + "&dependCode=" + stringParameter31 + "&saupNo=" + stringParameter32);
                }
                return;
            }
            catch (Exception ex3) {
