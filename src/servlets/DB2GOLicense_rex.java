...
public class DB2GOLicense_rex extends HttpServlet
{
    public void service(final HttpServletRequest req, final HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                fileWrite = String.valueOf(fileWrite) + "<row><접수번호><![CDATA[" + rs.getString(1) + "]]></접수번호>" + "<공공기관코드><![CDATA[" + rs.getString(2) + "]]></공공기관코드>" + "<공공기관명_전체><![CDATA[" + rs.getString(3) + "]]></공공기관명_전체>" + "<공공기관명_영문><![CDATA[" + ComStr.checkNull(rs.getString(4)) + "]]></공공기관명_영문>" + "<대표자><![CDATA[" + rs.getString(5) + "]]></대표자>" + "<대표자주민번호><![CDATA[" + DJuminNo_1 + "-" + DJuminNo_2 + "]]></대표자주민번호>" + "<우편번호><![CDATA[" + ZipCode_1 + "-" + ZipCode_2 + "]]></우편번호>" + "<주소><![CDATA[" + rs.getString(8) + "]]></주소>" + "<나머지주소><![CDATA[" + rs.getString(9) + "]]></나머지주소>" + "<사업자등록번호><![CDATA[" + SaupNumber_1 + "-" + SaupNumber_2 + "-" + SaupNumber_3 + "]]></사업자등록번호>" + "<팩스번호><![CDATA[" + ComStr.checkNull(rs.getString(11)) + "]]></팩스번호>" + "<담당자명><![CDATA[" + rs.getString(12) + "]]></담당자명>" + "<담당자주민번호><![CDATA[" + JuminNo_1 + "-" + JuminNo_2 + "]]></담당자주민번호>" + "<담당자부서명><![CDATA[" + rs.getString(14) + "]]></담당자부서명>" + "<담당자전화번호><![CDATA[" + rs.getString(15) + "]]></담당자전화번호>" + "<담당자메일주소><![CDATA[" + rs.getString(16) + "]]></담당자메일주소>" + "<사용자ID><![CDATA[" + ComStr.checkNull(rs.getString(17)) + "]]></사용자ID>" + "<공인인증기관><![CDATA[" + LicenseNm + "]]></공인인증기관>" + "<전자서명인증서고유명><![CDATA[" + ComStr.checkNull(rs.getString(19)) + "]]></전자서명인증서고유명>" + "<인가코드_접수내용><![CDATA[" + ComStr.checkNull(rs.getString(20)) + "-" + ComStr.checkNull(rs.getString(21)) + "]]></인가코드_접수내용>" + "</row>";
            }
        }
