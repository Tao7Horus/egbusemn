            ...
            try {
                ...
                for (int i4 = 1; i4 < dpTotalCount; ++i4) {
                    ...
                    if (dpStatus[i4].equals("I")) {
                        ...
                        this.icInsert(saupNo, ilno, "5", "I", "", ComStr.replace(ceoJuminNo[i4], "-", ""), "대표자주민번호", procID, con);
                        ++ilno;
                        this.icInsert(saupNo, ilno, "5", "I", "", ceoName[i4].trim(), "대표자명", procID, con);
                        ++ilno;
                        upCheck = "Y";
                    }
                        ...
                        for (int j2 = 0; j2 < DPb.length; ++j2) {
                            System.out.println("FOR 시작FFF===FOR" + DPb.length + "==" + ceoJuminNo[i4] + "===" + DPb[j2][1]);
                            if (ComStr.replace(ceoJuminNo[i4], "-", "").equals(DPb[j2][1])) {
                                ...
                                if (!ceoName[i4].equals(DPb[j2][0]) || !ceoMail[i4].equals(DPb[j2][2]) || !ceoYN[i4].equals(DPb[j2][3])) {
                                    ...
                                    upCheck = "Y";
                                    System.out.println("FOR 시작FFF===FOR  자료변경==YYYYYY" + ceoName[i4] + "===" + DPb[j2][0]);
                                    if (!ceoName[i4].equals(DPb[j2][0])) {
                                        this.icInsert(saupNo, ilno, "5", "U", DPb[j2][0], ceoName[i4].trim(), "대표자명", procID, con);
                                        ++ilno;
                                    }
                        ...
                        System.out.println("FOR 시작DDDDDDD1111====" + dpquery3 + "==" + ceoJuminNo[i4]);
                        ...
                        this.icInsert(saupNo, ilno, "5", "D", ComStr.replace(ceoJuminNo[i4], "-", ""), "", "대표자주민번호", procID, con);
                        ++ilno;
                        this.icInsert(saupNo, ilno, "5", "D", ceoName[i4].trim(), "", "대표자명", procID, con);
                        ++ilno;
                    }
                }
                ...
                for (int i5 = 1; i5 < gmTotalCount; ++i5) {
                    ...
                    System.out.println("FOR 시작" + gmStatus[i5]);
                    if (gmStatus[i5].equals("I")) {
                        ...
                        this.icInsert(saupNo, ilno, "4", "I", "", gmLicenseCode[i5].trim(), "면허코드", procID, con);
                        ++ilno;
                        this.icInsert(saupNo, ilno, "4", "I", "", gmLicenseBeginDate[i5].trim(), "면허취득일자", procID, con);
                        ++ilno;
                        this.icInsert(saupNo, ilno, "4", "I", "", ComStr.replace(gmSigongAccount[i5], ",", ""), "시공능력평가액", procID, con);
                        ++ilno;
                        upCheck = "Y";
                    }
                        ...
                        for (int j3 = 0; j3 < GMb.length; ++j3) {
                            if (gmLicenseCode[i5].trim().equals(GMb[j3][0])) {
                                ...
                                if (!gmLicenseNo[i5].equals(GMb[j3][2]) || !gmLicenseBeginDate[i5].equals(GMb[j3][3]) || !ComStr.replace(gmSigongAccount[i5], ",", "").equals(GMb[j3][4]) || !gmPeonggaYear[i5].equals(GMb[j3][5]) || !gmDpLicenseYN[i5].equals(GMb[j3][6])) {
                                    ...
                                    System.out.println("FOR 시작FFF===FOR  자료변경==YYYYYY");
                                    upCheck = "Y";
                                    System.out.println("FOR 시작FFF===FOR  자료변경==YYYYYY" + gmLicenseNo[i5] + "===" + GMb[j3][0]);
                                    if (!gmLicenseEndDate[i5].equals(GMb[j3][4])) {
                                        this.icInsert(saupNo, ilno, "4", "U", GMb[j3][4], gmLicenseBeginDate[i5], "면허취득일자", procID, con);
                                        ++ilno;
                                    }
                                    if (!gmSigongAccount[i5].equals(GMb[j3][5])) {
                                        this.icInsert(saupNo, ilno, "4", "U", GMb[j3][5], gmSigongAccount[i5], "시공능력평가액", procID, con);
                                        ++ilno;
                                    }
                        ...
                        this.icInsert(saupNo, ilno, "4", "D", gmLicenseCode[i5], "", "면허코드", procID, con);
                        ++ilno;
                        this.icInsert(saupNo, ilno, "4", "D", gmLicenseBeginDate[i5], "", "면허취득일자", procID, con);
                        ++ilno;
                        this.icInsert(saupNo, ilno, "4", "D", ComStr.replace(gmSigongAccount[i5], ",", ""), "", "시공능력평가액", procID, con);
                        ++ilno;
                    }
                }
                ...
                for (int i6 = 1; i6 < gjTotalCount; ++i6) {
                    System.out.println("FOR 시작====" + gjStatus[i6]);
                    if (gjStatus[i6].equals("F") || gjStatus[i6].equals("I") || gjStatus[i6].equals("U")) {
                        System.out.println("FOR 시작====등록시작==" + factoryName[i6].trim());
                        ...
                        System.out.println("FOR 끝====등록종료==" + factoryAddr[i6].trim());
                ...
                for (int i6 = 1; i6 < idTotalCount; ++i6) {
                    System.out.println("FOR 시작====" + idStatus[i6]);
                    if (idStatus[i6].equals("F") || idStatus[i6].equals("I") || idStatus[i6].equals("U")) {
                        System.out.println("FOR 시작====등록시작==" + ComStr.replace(juminNo[i6], "-", ""));
                        ...
                        System.out.println("FOR 끝====등록종료==" + name[i6].trim());
                    }
                }
                ...
                for (int i6 = 1; i6 < jpTotalCount; ++i6) {
                    ...
                    System.out.println("FOR 시작" + jpStatus[i6]);
                    if (jpStatus[i6].equals("I")) {
                        ...
                        this.icInsert(saupNo, ilno, "3", "I", "", goodsNo[i6].trim(), "물품분류번호", procID, con);
                        ++ilno;
                        this.icInsert(saupNo, ilno, "3", "I", "", makeYN[i6].trim(), "제조여부", procID, con);
                        ++ilno;
                        upCheck = "Y";
                    }
                        ...
                        for (int j4 = 0; j4 < JPb.length; ++j4) {
                            if (goodsNo[i6].trim().equals(JPb[j4][0])) {
                                ...
                                if (!formNo[i6].trim().equals(JPb[j4][1]) || !ComStr.replace(threeSale[i6], ",", "").equals(JPb[j4][2]) || !makeYN[i6].trim().equals(JPb[j4][3]) || !dpGoodsYN[i6].trim().equals(JPb[j4][4])) {
                                    ...
                                    System.out.println("FOR 시작FFF===FOR  자료변경==YYYYYY");
                                    upCheck = "Y";
                                    System.out.println("FOR 시작FFF===FOR  자료변경==YYYYYY" + goodsNo[i6] + "===" + JPb[j4][0]);
                                    if (!goodsNo[i6].equals(JPb[j4][0])) {
                                        this.icInsert(saupNo, ilno, "3", "U", JPb[j4][0], goodsNo[i6], "물품분류번호", procID, con);
                                        ++ilno;
                                    }
                                    if (!makeYN[i6].equals(JPb[j4][3])) {
                                        this.icInsert(saupNo, ilno, "3", "U", JPb[j4][3], makeYN[i6], "제조여부", procID, con);
                                        ++ilno;
                                    }
                        ...
                        this.icInsert(saupNo, ilno, "3", "D", goodsNo[i6], "", "물품분류번호", procID, con);
                        ++ilno;
                        this.icInsert(saupNo, ilno, "3", "D", makeYN[i6], "", "제조여부", procID, con);
                        ++ilno;
                    }
                }
                ...
                for (int i6 = 1; i6 < gpTotalCount; ++i6) {
                    ...
                    System.out.println("FOR 시작" + gpStatus[i6]);
                    if (gpStatus[i6].equals("I")) {
                        ...
                        this.icInsert(saupNo, ilno, "3", "I", "", ggoodsNo[i6].trim(), "물품분류번호", procID, con);
                        ++ilno;
                        this.icInsert(saupNo, ilno, "3", "I", "", gmakeYN[i6].trim(), "제조여부", procID, con);
                        ++ilno;
                        upCheck = "Y";
                    }
                        ...
                        for (int j4 = 0; j4 < GPb.length; ++j4) {
                            if (ggoodsNo[i6].trim().equals(GPb[j4][0])) {
                                ...
                                if (!gformNo[i6].trim().equals(GPb[j4][1]) || !ComStr.replace(gthreeSale[i6], ",", "").equals(GPb[j4][2]) || !gmakeYN[i6].trim().equals(GPb[j4][3]) || !gdpGoodsYN[i6].trim().equals(GPb[j4][4])) {
                                    ...
                                    System.out.println("FOR 시작FFF===FOR  자료변경==YYYYYY");
                                    upCheck = "Y";
                                    System.out.println("FOR 시작FFF===FOR  자료변경==YYYYYY" + ggoodsNo[i6] + "===" + GPb[j4][0]);
                                    if (!ggoodsNo[i6].equals(GPb[j4][0])) {
                                        this.icInsert(saupNo, ilno, "3", "U", GPb[j4][0], ggoodsNo[i6], "물품분류번호", procID, con);
                                        ++ilno;
                                    }
                                    if (!gmakeYN[i6].equals(GPb[j4][3])) {
                                        this.icInsert(saupNo, ilno, "3", "U", GPb[j4][3], gmakeYN[i6], "제조여부", procID, con);
                                        ++ilno;
                                    }
                        ...
                        this.icInsert(saupNo, ilno, "3", "D", ggoodsNo[i6], "", "물품분류번호", procID, con);
                        ++ilno;
                        this.icInsert(saupNo, ilno, "3", "D", gmakeYN[i6], "", "제조여부", procID, con);
                        ++ilno;
                    }
                }
                ...
                psmt1.clearParameters();
                query2 = " UPDATE 사용_조달업체마스터  SET 국적 = ?,     상호명 = ?,     영문상호명 = ?,     개업일자 = ?,     법인설립일자 = ?,     업무구분 = ?,     제조구분 = ?,     법인등록번호 = ?,     기업구분2 = ?,     기업구분해당년도 = ?,     자본금 = ?,     종업원수 = ?,     최근결산년월 = ?,     우편번호 = ?,     지역코드 = ?,     주소 = ?,     나머지주소 = ?,     전화번호 = ?,     FAX번호 = ?,     홈페이지 = ?,     특례해당여부 = ?,     등록유효일자 = ADD_MONTHS(SYSDATE, 24),     갱신일자 = SYSDATE,     처리자ID = ?,      승인지청 = ?  WHERE 사업자등록번호 = ? ";
                psmt2 = con.prepareStatement(query2);
                System.out.println("UPdate=====" + query2);
                query3 = " INSERT INTO 사용_조달업체마스터이력 (  사업자등록번호, 갱신일자, 국적, 상호명, 영문상호명,  개업일자, 법인설립일자, 업무구분, 제조구분, 대표업종코드_표준,  법인등록번호, 기업구분1, 기업구분2, 기업구분해당년도, 자본금,  종업원수, 최근결산년월, 우편번호, 지역코드, 주소,  나머지주소, 전화번호, FAX번호, 홈페이지, 특례해당여부,  대표물품분류번호, 대표면허코드, 대표대표자명,  대표인증여부, 처리자ID, 등록유효일자, 등록일자,승인지청  ) VALUES (  ?, SYSDATE, ?, ?, ?, ?,  ?, ?, ?, ?, ?,  ?, ?, ?, ?, ?,  ?, ?, ?, ?, ?,  ?, ?, ?, ?, ?,  ?, ?, ? , ?, ?, ADD_MONTHS(SYSDATE, 24), TO_DATE(SUBSTR(?,1,10),'YYYY-MM-DD'), ?  ) ";
