...
public class UM_RAV_ConuA010i_en extends HttpServlet
{
            ...
            try {
                ...
                if ("0".equals(step)) {
                    if ("1".equals(mode)) {
                        ...
                        pstmt.setString(1, bizRegNo2);
                        pstmt.setString(2, bizName);
                        pstmt.setString(3, reprName);
                        if (pstmt.executeUpdate() != 1) {
                            throw new Exception("[Lỗi đăng ký]");
                        }
...
//                    Log.debug("$$$$$$$$$$$$$$$$$ UM_RAV_ConuA010i mode = Phe nhu con tete duyet");
...
//                    final PreparedStatement pstmt3 = conn.prepareStatement(sql3);
...
//                    response.getWriter().write(recvNo);
                    ...
                    final PreparedStatement pstmt4 = conn.prepareStatement(sql4);
