...
public class DB2TXT03_rex extends HttpServlet
{
    public void service(final HttpServletRequest req, final HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (rs != null) {
                ...
                while (rs.next()) {
                    fileWrite = String.valueOf(fileWrite) + "<row><면허명><![CDATA[" + ComStr.checkNull(rs.getString(2)) + "]]></면허명>" + "<서울><![CDATA[" + ComStr.checkNull(rs.getString(3)) + "]]></서울>" + "<부산><![CDATA[" + ComStr.checkNull(rs.getString(4)) + "]]></부산>" + "<인천><![CDATA[" + ComStr.checkNull(rs.getString(5)) + "]]></인천>" + "<대구><![CDATA[" + ComStr.checkNull(rs.getString(6)) + "]]></대구>" + "<광주><![CDATA[" + ComStr.checkNull(rs.getString(7)) + "]]></광주>" + "<대전><![CDATA[" + ComStr.checkNull(rs.getString(8)) + "]]></대전>" + "<울산><![CDATA[" + ComStr.checkNull(rs.getString(9)) + "]]></울산>" + "<경기><![CDATA[" + ComStr.checkNull(rs.getString(10)) + "]]></경기>" + "<강원><![CDATA[" + ComStr.checkNull(rs.getString(11)) + "]]></강원>" + "<충북><![CDATA[" + ComStr.checkNull(rs.getString(12)) + "]]></충북>" + "<충남><![CDATA[" + ComStr.checkNull(rs.getString(13)) + "]]></충남>" + "<전북><![CDATA[" + ComStr.checkNull(rs.getString(14)) + "]]></전북>" + "<전남><![CDATA[" + ComStr.checkNull(rs.getString(15)) + "]]></전남>" + "<경북><![CDATA[" + ComStr.checkNull(rs.getString(16)) + "]]></경북>" + "<경남><![CDATA[" + ComStr.checkNull(rs.getString(17)) + "]]></경남>" + "<제주><![CDATA[" + ComStr.checkNull(rs.getString(18)) + "]]></제주>" + "<기타><![CDATA[" + ComStr.checkNull(rs.getString(19)) + "]]></기타>" + "</row>";
                }
                fileWrite = String.valueOf(fileWrite) + "</sub1>";
            }
            rs.close();
