...
public class UM_ADV_GovrA010c01_en extends HttpServlet
{
    public void service(final HttpServletRequest httpServletRequest, final HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        if (stringParameter23.equals("Insert")) {
            try {
                ...
                httpServletResponse.sendRedirect("/AD/UM_ADJ_GovrL010s_en.jsp?recept=" + maxReceptionID + "&approvalCode=" + string + "&G2BCODE=" + stringParameter);
                return;
            }
            catch (Exception ex) {
                try {
                ...
                Log.debug("UM_ADV_GovrA010c01.java flag[" + stringParameter23 + "] : " + ex.toString());
        ...
        if (stringParameter23.equals("approval")) {
            ...
            try {
                ...
                if (stringParameter24.equals("admit")) {
                    if (stringParameter33.toLowerCase().equals("s")) {
                        if (um_URB_CERT010.isDataExistOnEnterMaster(stringParameter7, connection) == 0) {
                            CommonMessage.printMsg("", "", "register again.", null, httpServletResponse);
                            return;
                        }
                    }
                    else if (um_URB_CERT010.isDataExistOnGigwanMaster(stringParameter, stringParameter7, connection) == 0) {
                        CommonMessage.printMsg("", "", "Can not approval", null, httpServletResponse);
                        return;
                    }
                    ...
                    CommonMessage.printMsg("", "5", "Done.", "", httpServletResponse);
                }
                else if (stringParameter24.equals("deny")) {
                    if (stringParameter33.toLowerCase().equals("s")) {
                        if (um_URB_CERT010.isDataExistOnEnterMaster(stringParameter7, connection) == 0) {
                            CommonMessage.printMsg("", "", "Do not approval.", null, httpServletResponse);
                            return;
                        }
                    }
                    else if (um_URB_CERT010.isDataExistOnGigwanMaster(stringParameter, stringParameter7, connection) == 0) {
                        CommonMessage.printMsg("", "", "Try register again.", null, httpServletResponse);
                        return;
                    }
                    ...
                    connection.commit();
                    connection.setAutoCommit(true);
                    CommonMessage.printMsg("", "5", "Updated.", "", httpServletResponse);
                }
                return;
            }
            catch (Exception ex2) {
                ...
                Log.debug("UM_ADV_GovrA010c01_en.java flag[" + stringParameter23 + "] : " + ex2.toString());
        ...
        if (stringParameter23.equals("DNSave")) {
            try {
                ...
                if (!stringParameter30.equals("") || !stringParameter31.equals("")) {
                    ...
                    connection.commit();
                    connection.setAutoCommit(true);
                    httpServletResponse.sendRedirect("/AD/UM_ADJ_GovrL025s01_en.jsp?g2bCode=" + g2bCode + "&dependCode=" + stringParameter31 + "&saupNo=" + stringParameter32);
                }
                return;
            }
            catch (Exception ex3) {
                ...
                Log.debug("UM_ADV_GovrA010c01.java flag[" + stringParameter23 + "] : " + ex3.toString());
        ...
        if (stringParameter23.equals("Submit")) {
            try {
                ...
                connection = trx.getConnection();
                connection.setAutoCommit(false);
                Log.debug("UM_ADV_GovrA010c01.java CERT_ORG[" + stringParameter18 + "] ");
                Log.debug("UM_ADV_GovrA010c01.java recept[" + stringParameter20 + "] ");
                Log.debug("UM_ADV_GovrA010c01.java G2BCODE[" + stringParameter + "] ");
                Log.debug("UM_ADV_GovrA010c01.java dependCode[" + stringParameter22 + "] ");
                um_URB_CERT010.updateCERT_ORG(stringParameter18, stringParameter20, stringParameter, stringParameter22, connection);
                connection.commit();
                connection.setAutoCommit(true);
                ...
                Log.debug("UM_ADV_GovrA010c01.java flag[" + stringParameter23 + "] : " + ex4.toString());
