...
public class Report_Code_04 extends HttpServlet
{
    ...
    private void headHtml(final PrintWriter out, final String desformat, final String local) throws Exception {
        ...
        out.println("<html>");
        out.println("<head>");
        out.println("<title>기업구분물품별 등록업체현황</title>");
        ...
        out.println("    <p align='center'><font size='5' face='굴림체'><b>기업구분물품별 등록업체현황</b></font></p></td>");
        out.println("</tr>");
        out.println("</table>");
        out.println("<br>");
