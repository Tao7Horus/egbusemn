...
public class DB2TXT07_rex extends HttpServlet
{
    public void service(final HttpServletRequest req, final HttpServletResponse res) throws ServletException, IOException {
        ...
        try {
            ...
            if (rs != null) {
                ...
                while (rs.next()) {
                    fileWrite = String.valueOf(fileWrite) + "<row><지역><![CDATA[" + ComStr.checkNull(rs.getString(1)) + "]]></지역>" + "<상호><![CDATA[" + ComStr.checkNull(rs.getString(2)) + "]]></상호>" + "<사업자등록번호><![CDATA[" + ComStr.checkNull(rs.getString(3)) + "]]></사업자등록번호>" + "<대표자><![CDATA[" + ComStr.checkNull(rs.getString(4)) + "]]></대표자>" + "<주민번호><![CDATA[" + ComStr.checkNull(rs.getString(5)) + "]]></주민번호>" + "<주소><![CDATA[" + ComStr.checkNull(rs.getString(6)) + "]]></주소>" + "<전화번호><![CDATA[" + ComStr.checkNull(rs.getString(7)) + "]]></전화번호>" + "<팩스번호><![CDATA[" + ComStr.checkNull(rs.getString(8)) + "]]></팩스번호>" + "<제조여부><![CDATA[" + ComStr.checkNull(rs.getString(9)) + "]]></제조여부>" + "</row>";
                }
                fileWrite = String.valueOf(fileWrite) + "</sub1>";
            }
            rs.close();
