...
public class Report_Code_05 extends HttpServlet
{
    ...
    private void headHtml(final PrintWriter out, final String desformat, final String province) throws Exception {
        out.println("<html>");
        out.println("<head>");
        out.println("<title>입찰대리인 명부조회  </title>");
        ...
        out.println("    <p align='center'><font size='5' face='굴림체'><b>입찰대리인명부현황</b></font></p></td>");
        out.println("</tr>");
        out.println("</table>");
        out.println("<br>");
