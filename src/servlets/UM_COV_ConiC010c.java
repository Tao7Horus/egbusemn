...
public class UM_COV_ConiC010c extends HttpServlet
{
    ...
    private void updateProcess(final UM_Auth_Check uac) throws Exception {
        ...
        final UM_RAB_RecPubInstituCert recPubInstituCert = new UM_RAB_RecPubInstituCert();
        ...
        try {
            ...
            //Loi voi hon 500 danh muc cong viec vi vay chuyen sang class2
            //mastEnterStdClsDAO.save(bizRegNo, stdClsList, conn);
            UM_RAB_MastEnterStdCls2 mastEnterStdClsDAO2 = new UM_RAB_MastEnterStdCls2();
            mastEnterStdClsDAO2.save(bizRegNo, stdClsList, conn);
            ...
            recPubInstituCert.modify5(bizRegNo,addr,conn);
            recSupplier.modify5(bizRegNo,addr,conn);
            mastReprDao.deleteAll(bizRegNo, conn);
            mastReprDao.save(bizRegNo, reprList, conn);
            
            //cap nhat nguoi dai dien pl vao thong tin nhan duoc khi dang ky
            recReprDao.delete(bizRegNo, conn);
            recReprDao.save(bizRegNo, reprList, conn);
