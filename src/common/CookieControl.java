...
public class CookieControl
{
    ...
    static {
        (CookieControl.USER_HASH = new Hashtable()).put("970251", "오연칠");
        CookieControl.USER_HASH.put("000201", "박소아");
        CookieControl.USER_HASH.put("000273", "송종인");
        CookieControl.USER_HASH.put("000305", "이은정");
        CookieControl.USER_HASH.put("000310", "김혜경");
    }
    
    public CookieControl(final HttpServletRequest req) {
        this.ope_Cooks = null;
    ...
    public String getValidUserCheck() throws Exception {
        ...
        if (!CookieControl.USER_HASH.containsKey(this.sabun)) {
