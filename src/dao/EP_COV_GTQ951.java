...
public class EP_COV_GTQ951 extends HttpServlet
{
    ...
    public void service(final HttpServletRequest httpServletRequest, final HttpServletResponse httpServletResponse) throws ServletException, IOException {
        ...
        ResultSet set = null;
        Trx trx = null;
        final String s = " select count(*) from UM_SUPPLIER_ENTER_MAST where BIZ_REG_NO like ?||'%' and BIZ_NM like '%'||?||'%'";
        final String s2 = " select t, BIZ_REG_NO, BIZ_NM from( \tselect BIZ_REG_NO, BIZ_NM, rownum t \tfrom ( \t\tselect BIZ_REG_NO, BIZ_NM  \t\tfrom UM_SUPPLIER_ENTER_MAST \t\twhere BIZ_REG_NO like ?||'%' \t\tand BIZ_NM like '%'||?||'%' \t\torder by 2 \t) ) where t > ? and t < ? ";
        try {
    ...
    private void initHtml(final PrintWriter printWriter, final String s, final String s2, final String s3, final String s4, final String s5, final String s6) {
        ...
        printWriter.println("\t\tdocument.ebid.action\t='/servlet/dao/EP_COV_GTQ951';\t");
        ...
        printWriter.println("<tr>");
        printWriter.println("<td class='tda1'>Tên công ty</td>");
        ...
        printWriter.println("</tr>");
        printWriter.println("<tr>");
        printWriter.println("\t<td\tclass='tda1'>Số ĐKKD</td>");
    ...
    private void noDataHtml(final PrintWriter printWriter) {
        ...
        printWriter.println("<td class=tdac>Số ĐKKD</td>");
